...
/**
 * Write a description of class MatOgInnhold here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class MatInnhold
{
     ...
     */
    public MatInnhold(String matNavn, int energiInnhold, double fettInnhold,double karbohydraterInnhold)
    {
